...
<!-- SLSP WG: Letters version 09/2021;
        ...
        02/2022 added anonymization for ZHdK with notice for patron -->
<!-- Dependance:
...
xmlns:str="http://exslt.org/strings">
    ...
    <xsl:template name="printUserAnonymize">
        ...
        <xsl:choose>
            ...
            <xsl:when test="($destination_id = '5512' or $destination_id = '41SLSP_ZHK') and (/notification_data/request/request_type = 'PATRON_PHYSICAL')"><!-- anonymize ZHdK IZ -->
            <!-- Please keep slip note for ZHdK -->
                <xsl:choose>
                    <xsl:when test="/notification_data/languages/string = 'de'">
                        <table style="border: 1px solid black">
                            <tr>
                                <td>
                                    <strong>Bitte aufbewahren</strong>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <span>Bei Rückgabe in einer Bibliothek mit bedienter Ausleihe muss dieser Transferbrief zwingend vorgewiesen werden.</span>
                                </td>
                            </tr>
                        </table>
                    </xsl:when>
                    <xsl:otherwise>
                        <table style="border: 1px solid black">
                            <tr>
                                <td>
                                    <strong>Please keep slip</strong>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <span>This transfer letter must be presented when returning the item to a library with served circulation desk.</span>
                                </td>
                            </tr>
                        </table>
                    </xsl:otherwise>
