				...
				<div class="messageArea">
					<div class="messageBody">
						<table role='presentation'  cellspacing="0" cellpadding="5" border="0">
                            ...
                            <!-- multi-volume-barcodes:
                            notification_data/request/multi_barcode_visible = "true"
                            notification_data/request/multi_item_barcode = rapido barcodes separated by ","
                            notification_data/request/multi_item_barcode_str - "Multiple barcodes"
                            this letter barcode:
                            notification_data/barcode
                            number of generated letters:
                            notification_data/request/num_of_child_requests-->
							<tr>
							  <td>
							  	<br/>
