...
<!-- The linking using owning library is not working in case of a GetIt request between libraries of one IZ.
Opened Idea Exchange ticket regarding adding pickup library code:
https://ideas.exlibrisgroup.com/forums/308173-alma/suggestions/46617034-add-pickup-library-code-to-on-hold-shelf-letter-f
-->
	<a>
		<xsl:attribute name="href">https://libraries.swisscovery.help/?lang=<xsl:value-of select="/notification_data/receivers/receiver/preferred_language"/>&#38;search=<xsl:value-of select="/notification_data/phys_item_display/library_code"/></xsl:attribute>
