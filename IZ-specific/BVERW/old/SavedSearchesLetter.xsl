	...
	<xsl:template match="/">
		...
		<body style = "padding: 0; font-family: Source Sans Pro,Helvetica Neue,Helvetica,Arial,sans-serif;">
			<table cellpadding="0" cellspacing="0" style="margin: auto; width: 600px;">
				<tr>
					<td style="background-color: #ffffff; color: #000000 border-top-left-radius: 15px; border-top-right-radius: 15px;">

                                         <!--HIDE OUT OF THE BOX LOGO CODE TO REPLACE WITH LINK TO LOGO IN CUSTOMIZATION PACKAGE-->
                            <img src="https://www.alexandria.ch/discovery/custom/41BIG_INST-ALEX/img/library-logo.png" alt="Alexandria" style="width: auto; height: auto; padding: .85em;">
				...
				<tr>
					<td style="background-color: #ffffff; padding: 0 15px; color: #000000; box-shadow: inset 0 3px 10px -2px rgba(0,0,0,0.3)">
				...
				<tr>
					<td style="background-color: #ffffff; color: #000000; padding: 15px; box-shadow: inset 0 3px 10px -2px rgba(0,0,0,0.3); font-style: italic;">
				...
				<tr>
					<td style="background-color: #ffffff; color: #000000; padding: 15px 0; box-shadow: inset 0 4px 5px -2px rgba(0,0,0,0.3)">
