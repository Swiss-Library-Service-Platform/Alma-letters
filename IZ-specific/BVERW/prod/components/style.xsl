...
<!-- Adaptations by Alexandria:
    04/2022 - specified fonts directly in body style -->
<xsl:stylesheet version="1.0"
xmlns:xsl="http://www.w3.org/1999/XSL/Transform">

<xsl:template name="generalStyle">
 <style>
 body {@@language_related_body_css@@ background-color:#fff; font-family: Arial, Helvetica, sans-serif}
...
font-family: Arial, Helvetica, sans-serif; color:#333; margin:0; padding:0em; font-size:80%; 
</xsl:template>
