...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <!-- special version with delivery address on left and special height for the envelope window-->

    <xsl:template name="senderReceiver-reversed-window">
        <br/>
        <table cellspacing="0" cellpadding="5" border="0" width="100%" height="47mm">
            <tr>
                <td width="50%" align="left">
                    <xsl:choose>
                        <xsl:when test="notification_data/user_for_printing">
