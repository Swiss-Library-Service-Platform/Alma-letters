...
<!--
    IZ customization: print a scannable barcode for user codes 01 and 02
...
xmlns:str="http://exslt.org/strings">
    ...
    <xsl:template name="printUserAnonymize">
        ...
        <xsl:choose>
            ...
            <!-- Code inserted from IZ HSG: If pickup location is 'SGKBV Bibliothek Hauptpost' print a scannable barcode for codes 01 and 02 -->
            <xsl:when test="/notification_data/request/calculated_destination_name = 'SGKBV Bibliothek Hauptpost'"><!-- no anonymization -->
                ...
                <xsl:if test="/notification_data/request/lastInterestDate != ''">
                    ...
                    <xsl:if test="/notification_data/user_for_printing/identifiers/code_value[code='01']/value">
                        Barcode edu-ID: <br />
            ...
            <!-- End of inserted code from IZ HSG-->
            <xsl:otherwise> <!-- no anonymization, no scannable barcode-->
                @@email@@: <xsl:value-of select="/notification_data/user_for_printing/email" /><br />
                @@tel@@: <xsl:value-of select="/notification_data/user_for_printing/phone" /><br />
                <xsl:if test="/notification_data/request/lastInterestDate != ''">
                    @@expiration_date@@: <xsl:value-of select="/notification_data/request/lastInterestDate" /><br />
